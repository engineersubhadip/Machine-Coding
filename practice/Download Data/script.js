// I have a button called Download Movie Names. Which when clicked returns the list of movie names after 5s
...
let downloadButton = document.querySelector(".downloadMovie");
...
downloadButton.addEventListener("click", function () {
    ...
    if (!flag){
        ...
        new Promise(function(resolve,reject){
          setTimeout(function(){
              movieList = data.map(function(ele){
                flag = false;
                  return ele.movie;
              })
              resolve(movieList);
